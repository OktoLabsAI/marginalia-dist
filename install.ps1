...
$DefaultWheelUrl = if ($env:MARGINALIA_DEFAULT_WHEEL_URL) {
    ...
    "https://github.com/OktoLabsAI/marginalia-dist/releases/download/v0.0.44/marginalia-0.0.44-py3-none-any.whl"
}
...
$ExpectedVersion = if ($env:MARGINALIA_EXPECTED_VERSION) { $env:MARGINALIA_EXPECTED_VERSION } else { "0.0.44" }
