...
DEFAULT_WHEEL_URL="${MARGINALIA_DEFAULT_WHEEL_URL:-https://github.com/OktoLabsAI/marginalia-dist/releases/download/v0.2.0/marginalia-0.2.0-py3-none-any.whl}"
...
EXPECTED_VERSION="${MARGINALIA_EXPECTED_VERSION:-0.2.0}"
